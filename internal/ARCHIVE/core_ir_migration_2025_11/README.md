...
All work is complete and merged to main. The CoreExpr infrastructure is production-ready and actively used.

See `BRANCH_README.md` (at repo root) for complete branch summary.
