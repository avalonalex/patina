...
5909; tree-walker 17 of 33, 5660 of 5689; `base` itself 1054 of 1064 on the VM and 1053 on the tree-walker (family 30). Bundling SRFI 134 as `(scheme ideque)` (2026-08-25) then took the VM lane to 20 of 33, 5995 of 6023, and the tree-walker to 18 of 33, 5774 of 5803; SRFI 144 as `(scheme flonum)` (2026-08-26) took them to 7274 of 7303 and 7053 of 7083, the suite counts unchanged because `flonum` keeps one failure that is not ours; SRFI 135 as `(scheme text)` (2026-08-26) took them to 21 of 33, 8302 of 8331 and 19 of 33, 8081 of 8111 — a clean 1028 of 1028, so this one does move the suite count. The R6RS lane
