...
table now (`MADE`, 111 shapes, scored against chibi and Gauche), 45 added for
family 47, 18 for #407's equal-values axis, 40 for #408's introducing generators, 6 for #438's defined-over import and 2 for #446's generator run in the program. What is left, in rough order of expected value: expansion nested
