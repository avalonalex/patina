...
121 — the one unshipped row *is* that superseded SRFI 121, so every Red library anyone can
import ships), **Tangerine 8 of 8** (SRFI 146, 160, 115 and 159 bundled 2026-09-18); the measured
priority order below is spent and marked as history.
...
| SRFI 159 | `(scheme show)` | Formatting/show | ✅ shipped | ✅ shipped (alias over the bundled `(srfi 159)`, 2026-09-18) |
