...
/// # Example
/// ```
/// use patina_frontend::macro_expander::hygiene::gensym;
/// use std::rc::Rc;
///
...
fn is_macro(name: &Rc<str>, env: &Rc<patina_runtime::Environment>) -> bool {
...
mod tests {
    ...
    fn empty_env() -> Rc<patina_runtime::Environment> {
        Rc::new(patina_runtime::Environment::new())
    }
