...
pub fn expand_macro(
    ...
    // Create expander with expansion-time environment
    // The captured environment for free variables is stored in the Identifier objects themselves
    let expander = Expander::new(expansion_env.clone());
