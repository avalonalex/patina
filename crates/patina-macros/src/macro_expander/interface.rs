...
impl TestExpander {
    ...
    /// ```
    ///
    /// NOTE: Temporarily disabled - needs Parser from patina-frontend
    /// Use from_compiled() instead for now
    #[allow(dead_code)]
    pub fn from_definition(_name: &str, _syntax_rules: &str) -> Result<Self, MacroError> {
        unimplemented!(
            "TestExpander::from_definition requires Parser - use from_compiled() instead"
        );
        /*
    ...
    pub fn assert_expands_to(&self, _input: &str, _expected: &str) -> Result<(), String> {
        unimplemented!("TestExpander::assert_expands_to requires Parser");
        /*
        use crate::parser::Parser;
    ...
    pub fn expand_to_string(&self, _input: &str) -> Result<String, String> {
        unimplemented!("TestExpander::expand_to_string requires Parser");
        /*
        use crate::parser::Parser;
