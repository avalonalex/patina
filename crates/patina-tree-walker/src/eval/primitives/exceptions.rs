...
pub(super) fn register(registry: &mut super::PrimitiveRegistry) {
    ...
    registry.register(PrimitiveFn::new_tagged(
        ...
        |eval, args, _tail| error(eval, args).map(EvalResult::Tagged),
    ));
    ...
    registry.register(PrimitiveFn::new_tagged(
        ...
        |eval, args, _tail| error_object_p(eval, args).map(EvalResult::Tagged),
    ));
    ...
    registry.register(PrimitiveFn::new_tagged(
        ...
        |eval, args, _tail| error_object_message(eval, args).map(EvalResult::Tagged),
    ));
    ...
    registry.register(PrimitiveFn::new_tagged(
        ...
        |eval, args, _tail| error_object_irritants(eval, args).map(EvalResult::Tagged),
    ));
    ...
    registry.register(PrimitiveFn::new_tagged(
        ...
        |eval, args, _tail| file_error_p(eval, args).map(EvalResult::Tagged),
    ));
    ...
    registry.register(PrimitiveFn::new_tagged(
        ...
        |eval, args, _tail| read_error_p(eval, args).map(EvalResult::Tagged),
    ));
    ...
    registry.register(PrimitiveFn::new_tagged(
        ...
        Arity::Exact(1),
        "Raises an exception.",
        |eval, args, _tail| raise(eval, args).map(EvalResult::Tagged),
    ));
    ...
    registry.register(PrimitiveFn::new_tagged(
        ...
        |eval, args, _tail| raise_continuable(eval, args).map(EvalResult::Tagged),
    ));
    ...
    registry.register(PrimitiveFn::new_tagged(
        ...
        |eval, args, _tail| with_exception_handler(eval, args).map(EvalResult::Tagged),
    ));
}
