...
;;
;; Vendored from ecraven/r7rs-benchmarks (Public Domain per the header
;; above), with the stdin-driven harness wrapper replaced by a direct
;; entry point (sboyer-run n) for Patina's Criterion benchmarks.
;;
(define alist
...
;; Direct entry point: returns the rewrite count for scaling parameter n
(define (sboyer-run n)
  (setup-boyer)
