...
const PINNED: &[(&str, u64)] = &[
    ...
    // `.sld` and an impl file is ours, the code between them is not.
    ("lib/srfi/134.sld", 0xc6fa489e7e5b289f),
    ("lib/srfi/134/ideque-impl.scm", 0xeadd47dfb4dc28e8),
...
const PINNED_TREES: &[&str] = &["lib/chibi", "lib/srfi/116", "lib/srfi/132", "lib/srfi/134"];
