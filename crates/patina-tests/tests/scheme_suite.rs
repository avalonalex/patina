...
const SUITE: &[(&str, i64)] = &[
    ...
    ("data/lists.scm", 77),
    ("data/numeric-operations.scm", 107),
    ...
    ("expansion/quasiquote-templates.scm", 39),
    ("expansion/syntax-rules.scm", 30),
    ("expansion/syntax-rules-literals.scm", 28),
