...
//! generated by another macro — no longer a guess at what would be worth
//! covering, since that axis produced a both-backend defect in 2026-09
//! (a pattern variable under `quote` was substituted in a hand-written macro
//! and not in a generated one; triage family 13), found through `(r6rs
//! enums)` rather than through this file and pinned in
//! `tests/scheme/expansion/syntax-rules.scm` instead; a macro imported
