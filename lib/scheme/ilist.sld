;; (scheme ilist) - R7RS-large Red Edition
;;
;; Immutable lists.
;;
;; R7RS-large names this library `(scheme ilist)`; it is SRFI 116 under its
;; standard-track name. This is a pure re-export of `(srfi 116)` -- the
