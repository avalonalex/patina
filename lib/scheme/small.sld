;; (scheme small) - The R7RS-small language as one library
;;
;; R7RS-large defines (scheme small) as the union of the fifteen R7RS-small
;; libraries, and Snow packages import it by that name (chrisoei-cint in the
;; vendored corpus). Pure re-export; the name inventory is R7RS-small's own,
;; cross-checked against chibi's lib/scheme/small.sld.
