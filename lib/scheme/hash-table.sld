;; (scheme hash-table) — R7RS-large Red edition, which adopts SRFI 125.
;;
;; A re-export rather than an implementation: the edition names SRFI 125's
;; bindings unchanged, so there is nothing here to diverge from it.
