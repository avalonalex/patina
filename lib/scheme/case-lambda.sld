...
;;; Implements case-lambda using SRFI-16 reference implementation
;;;
;;; See: https://srfi.schemers.org/srfi-16/srfi-16.html
...
(define-library (scheme case-lambda)
  ...
  (begin
    ...
    ;; SRFI-16 reference implementation
    ;; Uses literal markers ("CLAUSE" and "IMPROPER") to handle the complex
    ;; recursive pattern matching needed for case-lambda.
