...
(define (string-drop str n)
  ;; PATINA LOCAL EDIT: upstream calls `(substring str n)`. R7RS 6.7 gives
  ;; `substring` exactly three arguments; the two-argument form is a chibi
  ;; extension, and Gauche and Chez reject it as we do. Supplying the end
  ;; explicitly is what chibi's own default computes.
